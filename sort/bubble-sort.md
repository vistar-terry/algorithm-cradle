...
# 验证优化效果
loop_number = 1000000
print("bubble_sort:", timeit.timeit("bubble_sort([1,2,3,4,5,6,7,8])", 
	"from __main__ import bubble_sort", number=loop_number))
print("bubble_sort1:", timeit.timeit("bubble_sort1([1,2,3,4,5,6,7,8])", 
	"from __main__ import bubble_sort1", number=loop_number))
print("bubble_sort_check_swapped: ", timeit.timeit("bubble_sort_check_swapped([1,2,3,4,5,6,7,8])", 
	"from __main__ import bubble_sort_check_swapped", number=loop_number))
print("bubble_sort_ignore_done: ", timeit.timeit("bubble_sort_ignore_done([1,2,3,4,5,6,7,8])", 
	"from __main__ import bubble_sort_ignore_done", number=loop_number))
```
