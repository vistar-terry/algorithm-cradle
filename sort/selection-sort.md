...
if __name__ == "__main__":
    ...
    #     "selection_sort([12,4,15,7,8,26,16,25,8,85])", 
    #     "from __main__ import selection_sort", number=10000))
    # print("selection_sort2:", timeit.timeit(
    #     "selection_sort2([12,4,15,7,8,26,16,25,8,85])", 
    #     "from __main__ import selection_sort2", number=10000))
```
