...
if __name__ == "__main__":
    ...
    # 验证效率优化
    print("selection_sort:", timeit.timeit("selection_sort([12,4,15,7,8,26,16,25,8,85])", 
    	"from __main__ import selection_sort", number=1000000))
    print("selection_sort_better:", timeit.timeit("selection_sort_better([12,4,15,7,8,26,16,25,8,85])", 		"from __main__ import selection_sort_better", number=1000000))
```
